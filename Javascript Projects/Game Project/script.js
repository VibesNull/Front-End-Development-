...
const openingScreen = document.querySelector(".intro")
...
const locations = [
  {
    name: "town square",
    "button text": ["Go to Rema", "Go to forest", "Fight mor"],
    "button functions": [goStore, goForest, fightMor],
    text: "You are in Tilst. You see a sign that says \"Rema 1000\"."
  },
  {
    name: "store",
  ...
  { 
    ...
    "button text": ["REPLAY?", "REPLAY?", "REPLAY?"], 
    "button functions": [restart, restart, restart], 
    text: "You defeated Mor! YOU WIN THE GAME! &#x1F389;" 
  },
  {
    name: "easter egg",
    "button text": ["2", "8", "Go to town town?"],
...
button3.onclick = fightMor;
buttonOpen.onclick = openGame;
